 ...
 */
public abstract class RobinCreature extends Creature {
    ...
    public RobinCreature(Type type, Simulator parent, int playerID, int x, int y) {
    ...
    protected Move getRobinAction(Type map[][], char[] objective){
        ...
        return root.searchTreeThroughEnvironmentUntilObjectiveIsReached();
    }
    ...
    class Square{
        ...
        protected Move searchTreeThroughEnvironmentUntilObjectiveIsReached(){
